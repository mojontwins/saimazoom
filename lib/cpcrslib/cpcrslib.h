...
extern void  __FASTCALL__ __LIB__   cpc_PutSpTileMap4x8Px(int sprite);
extern void  __FASTCALL__ __LIB__   cpc_PutSpTileMap8x8PxM1(int sprite);
extern void  __FASTCALL__ __LIB__   cpc_PutSpTileMap8x16(int sprite);
extern void  __FASTCALL__ __LIB__   cpc_PutSpTileMap8x16Px(int sprite);
extern void  __FASTCALL__ __LIB__   cpc_PutSpTileMap16x16PxM1(int sprite);
extern void  __FASTCALL__ __LIB__   cpc_PutSpTileMap8x24(int sprite);
extern void  __FASTCALL__ __LIB__   cpc_PutSpTileMap8x24Px(int sprite);
extern void  __FASTCALL__ __LIB__   cpc_PutSpTileMap16x24PxM1(int sprite);
extern void  __FASTCALL__ __LIB__   cpc_PutSpTileMap12x24CA(int sprite);
...
extern void  __FASTCALL__ __LIB__   cpc_PutTrSp4x8TileMap2bG(int sprite);
...
extern void  __FASTCALL__ __LIB__   cpc_PutTrSp8x16TileMap2bPx(int sprite);
extern void  __FASTCALL__ __LIB__   cpc_PutTrSp8x16TileMap2bGPx(int sprite);
extern void  __FASTCALL__ __LIB__   cpc_PutTrSp16x16TileMap2bPxM1(int sprite);
extern void  __FASTCALL__ __LIB__   cpc_PutTrSp8x24TileMap2b(int sprite);
extern void  __FASTCALL__ __LIB__   cpc_PutTrSp8x24TileMap2bG(int sprite);
extern void  __FASTCALL__ __LIB__   cpc_PutTrSp8x24TileMap2bPx(int sprite);
extern void  __FASTCALL__ __LIB__   cpc_PutTrSp8x24TileMap2bGPx(int sprite);
extern void  __FASTCALL__ __LIB__   cpc_PutTrSp16x24TileMap2bPxM1(int sprite);
extern void  __FASTCALL__ __LIB__   cpc_PutTrSp12x24TileMap2bGCA(int sprite);
